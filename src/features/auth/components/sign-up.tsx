...
import { signUpSchema, type SignUpFormInput, type SignUpFormOutput } from '@/schemas/auth'
      ...
      <form
        ...
        <div className="p-8 pb-6">
          <div>
            ...
            <h1 className="mb-1 mt-4 text-xl font-semibold">Create a SellerBoost Account</h1>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            ...
            <Button
              ...
              <svg viewBox="0 0 666.667 666.667" width="1em" height="1em">
                <defs>
                  <clipPath id="facebook_icon__b" clipPathUnits="userSpaceOnUse">
                    <path d="M0 700h700V0H0Z"/>
                  </clipPath>
                </defs>
                <g clipPath="url(#facebook_icon__b)" transform="matrix(1.33333 0 0 -1.33333 -133.333 800)">
