...
import { loginSchema, type LoginFormInput, type LoginFormOutput } from '@/schemas/auth'
...
export default function LoginPage() {
  ...
  async function onSubmit(data: LoginFormInput) {
    ...
    const res = await loginAction(data as LoginFormOutput)

    if (res?.success === false) {
      toast.error(res.error || "Failed to sign in")
    } else {
      // If loginAction succeeds, it will redirect server-side
      ...
      <form
        ...
        <div className="p-8 pb-6">
          <div>
            ...
            <h1 className="mb-1 mt-4 text-xl font-semibold">Sign In to SellerBoost</h1>
