...
export const teamMembers = pgTable(
  ...
  (table) => [
    uniqueIndex("idx_team_members_business_user").on(
      table.businessId,
      table.userId,
    ),
  ],
...
export const customers = pgTable(
  "customers",
  {
    ...
    businessId: integer("business_id")
      .notNull()
      .references(() => businesses.id, { onDelete: "cascade" }),
    userProfileId: integer("user_profile_id").references(
      () => userProfiles.id,
      { onDelete: "set null" },
    ),
...
export const conversations = pgTable(
  ...
  (table) => [
    ...
    index("idx_conversations_business_id").on(
      table.businessId,
      table.lastMessageAt,
    ),
...
export const conversationLabels = pgTable(
  ...
  (table) => [
    uniqueIndex("idx_conversation_labels_business_name").on(
      table.businessId,
      table.name,
    ),
  ],
...
export const conversationLabelAssignments = pgTable(
  ...
  (table) => [
    uniqueIndex("idx_conversation_label_assignments_conv_label").on(
...
export const messages = pgTable(
  "messages",
  {
    ...
    authorId: integer("author_id").references(() => users.id, {
      onDelete: "set null",
    }), // for internal notes, who wrote it
  ...
  (table) => [
    ...
    index("idx_messages_conversation_timestamp").on(
      table.conversationId,
      table.timestamp,
    ),
  ],
...
export const invoices = pgTable(
  ...
  (table) => [
    index("idx_invoices_business_created").on(
      table.businessId,
      table.createdAt,
    ),
...
export const payments = pgTable(
  ...
  (table) => [
    index("idx_payments_business_created").on(
      table.businessId,
      table.createdAt,
    ),
